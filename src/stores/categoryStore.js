...
import * as categoryApi from '@/api/categoryApi' // Giả định bạn đã tạo file này
...
export const useCategoryStore = defineStore('categoryStore', () => {
    ...
    async function fetchCategories() {
        ...
        try {
            ...
            const flatList = await categoryApi.fetchFlatCategories() // Giả định tên hàm trong API

...
<template>
  ...
  >
    ...
    <div class="flex justify-center items-center h-40 mb-4">
      <img
        :src="product.image"
        class="max-h-full max-w-full object-contain rounded-md pointer-events-none"
      />
    </div>
    
    <!-- Hàng 2: Tên sản phẩm (giới hạn 2 dòng) -->
    ...
    <!-- Hàng 4: Icon giỏ hàng -->
    <div class="flex justify-center mt-auto">
      <button class="bg-primary hover:bg-primary_hover text-white p-2 rounded-full transition">

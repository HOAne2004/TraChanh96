    ...
    <div class="bg-white dark:bg-gray-800 p-8 rounded-xl shadow-lg">
        ...
        <form @submit.prevent="handleSubmit" class="space-y-6">
            ...
            <div>
                ...
                />
                <p class="text-xs text-gray-500 mt-1">Số điện thoại dùng để đăng nhập, không thể chỉnh sửa.</p>
            </div>
            
            <div>
                <label for="address" class="block text-sm font-medium mb-1">Địa chỉ giao hàng mặc định</label>
                <textarea
                    id="address"

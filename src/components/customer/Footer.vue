...
<template>
  <div
    class="p-4 grid grid-cols-1 sm:grid-cols-3 bottom-0 w-full bg-white dark:bg-dark dark:text-white"
  >
    <!-- Logo -->
    <div class="w-full">
    ...
    <div class="text-left flex flex-col gap-4">
      ...
      <ul>
        ...
        <div class="flex gap-2">
          <input type="text" placeholder="Nhập email của bạn" class="border p-1 rounded" />
